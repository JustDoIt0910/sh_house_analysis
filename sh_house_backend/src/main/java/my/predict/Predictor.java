...
public class Predictor {
     ...
     */
    public Predictor(double[] x, double[] y, int n) {
     ...
     * @param n The order of polynomial
     */
    public Predictor(double[] x, double[] y, double[] weight, int n) {
    ...
    public static void main(String[] args) {
        Predictor eastSquareMethod =
                new Predictor(new double[] {0.5, 1.0, 1.5, 2.0, 2.5, 3.0},
